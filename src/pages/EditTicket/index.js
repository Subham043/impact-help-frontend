...
const Index = () => {
    ...
    const newTicketHandler = async () => {
        ...
        try {
            ...
            const response = await axiosPrivate.post(`/ticket/edit/${id}`, formData,);
            // console.log(response)
    ...
    const deleteImage = async(imageId) => {
        showLoader()
        try {
        const response = await axiosPrivate.delete(`/ticket/delete-image/${imageId}`);
    ...
    return (
        <InnerDashboardLayout>
            <DashboardHeader name="Edit Ticket" link={`/view-ticket/${id}`} routeName="View Ticket" />
